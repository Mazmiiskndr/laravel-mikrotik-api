...
<div class="card-body">
    ...
    <form wire:submit.prevent="storeNewService" method="POST">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12 mb-3">
                <x-input-group type="number" type="number" id="downloadRate" label="Download Rate" model="downloadRate"
                    placeholder="Download Rate" appendText="Kbps" required
                    tooltip="Download speed on kilobit per second (Kbps)." />
            </div>
            <div class="col-lg-6 col-md-6 col-12 mb-3">
                <x-input-group type="number" id="uploadRate" label="Upload Rate" model="uploadRate"
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12 mb-3">
                <x-input-group type="number" id="idleTimeout" label="Idle Timeout" model="idleTimeout"
            ...
            <div class="col-lg-6 col-md-6 col-12 mb-3">
                <x-input-group type="number" id="sessionTimeout" label="Session Timeout" model="sessionTimeout"
        ...
        <div class="row">
            <div class="col-lg-5 col-md-4 col-12 mb-3">
                <x-input-field type="number" id="serviceCost" label="Service Cost" model="serviceCost"
                    placeholder="Enter a Service Cost.." />
            </div>
            <div class="col-lg-4 col-md-4 col-6 mb-3">
                <x-select-field id="currency" label="Currency" model="currency" :options="[
                        'IDR' => 'IDR',
                        'USD' => 'USD',
                        'EUR' => 'EUR',
                        'SGD' => 'SGD',
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-6 mb-3">
                <x-input-field type="number" id="priority" label="Priority" model="priority"
