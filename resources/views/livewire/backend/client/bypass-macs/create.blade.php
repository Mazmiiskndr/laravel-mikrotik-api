<div>
    <div wire:ignore.self class="modal fade" id="createNewMac" tabindex="-1" aria-hidden="true"
        data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalCenterTitle">Add New Mac</h5>
                    <x-button color="close" dismiss="true" click="closeModal" />
                </div>
                <form wire:submit.prevent="storeNewMac" method="POST">
                    <div class="modal-body">
                        {{-- FORM INPUT MAC ADDRESS AND STATUS --}}
                        <div class="row">
                            <div class="col-lg-6 col-12 mb-3">
                                <x-input-field type="text" id="macAddress" label="Mac Address" model="macAddress"
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12 mb-3">
                                <x-select-field id="server" label="Server" model="server" required :options="$servers"
