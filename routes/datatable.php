...
Route::middleware(['check.session.cookie'])->group(function () {
    ...
    Route::prefix('livewire/backend/')->group(function () {
        ...
        Route::prefix('client/')->group(function () {
            ...
            Route::get('bypassedMacs/getDataTable', [DataTableBypassedMacs::class, 'getDataTable'])->name('bypassedMacs.getDataTable');
            Route::get('blockedMacs/getDataTable', [DataTableBlockedMacs::class, 'getDataTable'])->name('blockedMacs.getDataTable');
